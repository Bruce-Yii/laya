...
Routing, the HTTP API, confidence gating, benchmarks and known limits are in the
[README](https://github.com/NandhaKishorM/laya#readme) for now. The command line and MCP server
have a focused guide here: [Command line and MCP server](cli-mcp.md).
